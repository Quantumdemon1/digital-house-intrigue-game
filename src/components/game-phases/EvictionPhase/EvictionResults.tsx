...
const EvictionResults: React.FC<EvictionResultsProps> = ({
  ...
  return <div className="space-y-6 text-center">
      ...
      {!showFinalResult ? <div className="space-y-8">
          ...
          <div className="p-6 bg-opacity-80 rounded-lg border border-red-200 bg-gray-950">
            ...
            {evictedHouseguest.isPlayer ? <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-md">
                <p className="font-bold text-red-700">
                  You have been evicted from the Big Brother house.
                </p>
              </div> : <div className="mt-6">
                <Button onClick={handleCompleteEviction} className="bg-red-600 hover:bg-red-700" size="lg" disabled={isProcessing}>
