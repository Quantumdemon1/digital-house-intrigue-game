...
const EvictionPhase: React.FC = () => {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto shadow-lg border-2 border-red-100/30">
      <CardHeader className="bg-gradient-to-r from-red-50/50 to-red-100/30 border-b">
      ...
      <CardContent className="p-6">
        {/* Nominees banner */}
        <div className="bg-slate-100 p-4 mb-6 rounded-lg flex items-center justify-between">
          <div>
