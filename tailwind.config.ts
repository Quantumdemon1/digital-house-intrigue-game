    ...
    extend: {
      ...
      keyframes: {
        ...
        'celebrate-winner': {
          '0%': { 
            transform: 'scale(1)',
            boxShadow: '0 0 0 0 rgba(0, 90, 154, 0.7)'
          },
          '50%': { 
            transform: 'scale(1.05)',
            boxShadow: '0 0 0 10px rgba(0, 90, 154, 0)'
          },
          '100%': { 
            transform: 'scale(1)',
            boxShadow: '0 0 0 0 rgba(0, 90, 154, 0)'
          }
        },
        'phase-transition': {
          '0%': {
      ...
      animation: {
        ...
        'camera-scan': 'camera-scan 3s linear infinite',
        'competition-progress': 'competition-progress 3s infinite alternate',
        'celebrate-winner': 'celebrate-winner 2s infinite',
