...
serve(async (req) => {
  ...
  try {
    ...
    // Build detailed prompt for realistic portrait
    const fullPrompt = `Professional headshot portrait of ${prompt}. 
      Reality TV show contestant, high quality studio lighting, neutral gray background.
      Confident, friendly expression. Shoulders and face visible.
      Photorealistic style, high resolution. Ultra high resolution.`;

    console.log("Generating avatar with prompt:", fullPrompt);
